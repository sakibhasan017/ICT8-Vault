...
export default function Exam() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editId) {
        await axios.put(`${import.meta.env.VITE_API_BASE_URL}/api/exam/update/${editId}`, formData);
      } else {
        await axios.post(`${import.meta.env.VITE_API_BASE_URL}/api/exam/add`, formData);
      }
      fetchExams();
      setMode('list');
      setFormData({ 
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`${import.meta.env.VITE_API_BASE_URL}/api/exam/delete/${id}`);
      fetchExams();
    } catch (error) {
