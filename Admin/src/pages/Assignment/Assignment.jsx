...
export default function Assignment() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editId) {
        await axios.put(`${import.meta.env.VITE_API_BASE_URL}/api/assignment/update/${editId}`, formData);
      } else {
        await axios.post(`${import.meta.env.VITE_API_BASE_URL}/api/assignment/add`, formData);
      }
      fetchAssignments();
      setMode('list');
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`${import.meta.env.VITE_API_BASE_URL}/api/assignment/delete/${id}`);
      fetchAssignments();
    } catch (error) {
