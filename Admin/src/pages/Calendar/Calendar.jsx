...
export default function Calendar() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editId) {
        await axios.put(`${import.meta.env.VITE_API_BASE_URL}/api/calendar/update/${editId}`, formData);
      } else {
        await axios.post(`${import.meta.env.VITE_API_BASE_URL}/api/calendar/add`, formData);
      }
      fetchEvents();
      setMode('list');
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`${import.meta.env.VITE_API_BASE_URL}/api/calendar/delete/${id}`);
      fetchEvents();
    } catch (error) {
